...
from models.gcn_r import GCNNet
...
for i in range(5):
    ...
    result_file_name = 'data/result/GCNNet(DrugA_DrugB)_R' + str(i) + '--result_' + datafile + '.csv'
    file_AUCs = 'data/result/GCNNet(DrugA_DrugB)_R' + str(i) + '--AUCs--' + datafile + '.txt'
