...
for i in range(5):
    ...
    # print('len(drug2_data)', len(drug2_data))
    ...
    model_file_name = 'data/result/GAT_GCN(shared weight)' + str(i) + '--model_' + datafile +  '.model'
    result_file_name = 'data/result/GAT_GCN(shared weight)' + str(i) + '--result_' + datafile +  '.csv'
    file_AUCs = 'data/result/GAT_GCN(shared weight)' + str(i) + '--AUCs--' + datafile + '.txt'
